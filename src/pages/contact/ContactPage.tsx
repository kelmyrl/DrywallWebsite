...
export function ContactPage() {
  return (
    <section className="contact-page" aria-label="About and contact page">
      <div className="contact-page__inner">
        <h1>Lemus Drywall</h1>
        <h2>Contact Us</h2>

        <div className="contact-page__socials" aria-label="Social media links">
          <a href="#" aria-label="Facebook" className="contact-page__social-link">
          ...
          <a href="#" aria-label="Instagram" className="contact-page__social-link">
            <svg viewBox="0 0 24 24" role="presentation">
          ...
          <a href="#" aria-label="Google" className="contact-page__social-link">
            <svg viewBox="0 0 24 24" role="presentation">
